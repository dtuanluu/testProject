...
public class WaitClickable implements Waiting {
    ...
    public WebElement waitingById(String name, String id) {
        try {
            ...
            WebElement webElement = wait.until(ExpectedConditions.elementToBeClickable(By.id(id)));
    ...
    public WebElement waitingByClassName(String name, String className) {
        try {
            ...
            WebElement webElement = wait.until(ExpectedConditions.elementToBeClickable(By.className(className)));
